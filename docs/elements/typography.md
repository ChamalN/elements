...
{{#demo}}
<p>
  To switch directories, type <kbd lass="pe-kbd">cd</kbd> followed by the name of the directory.<br/>
  To edit settings, press <kbd lass="pe-kbd">ctrl</kbd> + <kbd lass="pe-kbd">,</kbd>
</p>
{{/demo}}
